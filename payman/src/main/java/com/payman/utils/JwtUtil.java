...
public class JwtUtil {
    ...
    public String generateToken(UserDetails userDetails) {
        ...
        Customer customer = customerRepository.fetchByMobileExact(userDetails.getUsername());
        claims.put("customerId", customer.getId());
        claims.put("enabled", customer.getEnabled());
        claims.put("type", customer.getType());
        claims.put("full_name", customer.getFullName());
